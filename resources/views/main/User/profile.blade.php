    ...
    <div class="w-full max-w-xs m-2 mx-auto bg-white rounded overflow-hidden shadow-md user-div">
      ...
      <div class="p-3 body">
        ...
        <div class="d-flex flex-column m-3 setting">
          <div class="font-bold text-base mb-2 li active"><a class="w-100">Personal Info.</a></div>
          <div class="font-bold text-base mb-2 li"><a class="w-100">Orders</a></div>
          <div class="font-bold text-base mb-2 li"><a class="w-100">Settings</a></div>
        </div>
      </div>
    </div>
